      ...
      <div className="flex rounded-lg border border-border bg-card overflow-hidden shadow-card" style={{ height: 'calc(100vh - 80px)' }}>
        ...
        <div className="w-72 shrink-0 border-r border-border flex flex-col">
          ...
          <div className="p-3 border-b border-border">
            <h2 className="text-sm font-bold text-foreground mb-2">{t('title', '消息')}</h2>
          </div>
        ...
        <div className="flex-1 flex items-center justify-center bg-secondary/20">
          <div className="text-center">
            ...
            <h2 className="text-lg font-semibold mb-1 text-foreground">{t('emptyTitle', '选择一个对话')}</h2>
            <p className="text-sm text-muted-foreground">
              {t('emptyDescription', '从左侧选择一个对话开始聊天')}
            </p>
          </div>
        </div>
      </div>
