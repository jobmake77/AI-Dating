...
- **五大板块**:
  | 板块 | slug | 内容类型 |
  |------|------|---------|
  | 源码深潜 | source-code | 开源项目源码解读 |
  | 实战工坊 | workshop | 手把手项目教程 |
  | 架构之道 | architecture | 系统设计、技术选型 |
  | AI前沿 | ai-frontier | 大模型应用、部署 |
  | 面试通关 | interview | 大厂面经、算法题 |
...
| /api/categories | GET | 板块列表 |
| /api/categories/[slug] | GET | 板块内容 |
